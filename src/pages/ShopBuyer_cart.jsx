...
export default function ShopBuyer_cart() {
  ...
  const handlePayment = async () => {
    try {
      ...
      // ✅ Let Cashfree redirect to React route after payment
      cashfree.checkout({
        paymentSessionId,
  ...
  return (
    <div className="shopbuyer-cart">
      <header className="shopbuyer-header">
        <div className="welcome-text">Welcome Shop Buyer: {username}</div>
      </header>
